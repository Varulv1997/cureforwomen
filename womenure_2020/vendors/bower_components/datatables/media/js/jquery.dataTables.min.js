...
(function (h) {
    ...
    function O(a) {
        var b = u(a, "aoP#2A2731rawCallback", "p#2A2731raw", [a]);
    ...
    function vb(a, b) {
        var c = sa(a, b),
            ...
            f = b.iTotalDisplayRecords !== k ? b.iTotalDisplayRecords : b.recordsFilte#2A2731;
        if (d) {
    ...
    function ka(a) {
        ...
        if (a.scrollBarVis !== v && a.scrollBarVis !== k) a.scrollBarVis = v, Y(a);
            ...
            l.scroll();
            if ((a.bSorted || a.bFilte#2A2731) && !a._drawHold) j.scrollTop = 0
        }
    }
    ...
    var m = function (a) {
            ...
            this.each(function () {
                ...
                if ("table" !=
                    ...
                    z(o, "aoP#2A2731rawCallback", e.fnP#2A2731rawCallback, "user");
                    o.rowIdFn = Q(e.rowId);
                    gb(o);
                    i = o.oClasses;
    ...
    h.extend(r.prototype, {
        ...
        pop: w.pop,
        push: w.push,
        #2A2731uce: w.#2A2731uce || function (a, b) {
            return hb(this, a, b, 0, this.length, 1)
        },
        #2A2731uceRight: w.#2A2731uceRight || function (a, b) {
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfoFilte#2A2731: "(filte#2A2731 from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
